...
class Personnel(models.Model):
    ...
    photo = models.ImageField(upload_to= "images/personnels")
...
class Voiture(models.Model):
    ...
    horaire = models.ForeignKey(HoraireClasse, related_name="voiture_classevoiture", on_delete=models.CASCADE)
   
 
    
class Reservation(models.Model):
    montant_paye = models.BigIntegerField(blank = False)
    avance_paye = models.BigIntegerField(default=0)
...
class Paiement(models.Model):
    ...
    reservation = models.ForeignKey(Reservation, related_name="reservations_paiement", on_delete=models.CASCADE)
